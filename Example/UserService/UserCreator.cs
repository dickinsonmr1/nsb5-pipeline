...
namespace UserService
{
    ...
    //        // This is where the user would be added to the database. The database command would auto-enlist in the ambient transaction and either succeed or fail along with the message being processed.
